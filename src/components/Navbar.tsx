      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex-shrink-0">
            <img src="/timer-logo.png" alt="Timer Consulting" className="h-12 brightness-0 invert" />
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-gray-900">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="#services" className="block px-3 py-2 text-gray-300 hover:text-white">Serviços</a>
            <a href="#about" className="block px-3 py-2 text-gray-300 hover:text-white">Sobre</a>
            <a href="#contact" className="block px-3 py-2 text-gray-300 hover:text-white">Contato</a>
            <Button variant="outline" className="w-full mt-2 text-white border-white hover:bg-white hover:text-gray-900">
              Agende uma Consulta
            </Button>
          </div>
        </div>
